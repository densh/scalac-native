 ...
 */
class ByteCodeRepository(val classPath: ClassFileLookup[AbstractFile], val isJavaSourceDefined: InternalName => Boolean, val classes: mutable.Map[InternalName, Either[ClassNotFound, (ClassNode, Source, Long)]]) {
